...
Source: https://platform.minimaxi.com/docs/api-reference/image-generation-i2i
  ...
  schemas:
    ...
    ImageSubjectReference:
      ...
      properties:
        type:
          type: string
          description: 主体类型，当前仅支持 `character` (人像)
        image_file:
          type: string
          description: "参考图文件。支持公网 URL 或 Base64 编码的 [Data URL](https://developer.mozilla.org/en-US/docs/Web/URI/Reference/Schemes/data) (`data:image/jpeg;base64,...`)\n为获得最佳效果，请上传单人正面照片\n\n- 图片要求：\n\t- 格式：JPG, JPEG, PNG\n\t- 大小：小于 10MB"
    StyleObject:
      type: object
      properties:
        style_type:
